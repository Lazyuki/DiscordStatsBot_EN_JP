...
module.exports = class Util {
  static const REGEX_JPN = /[\u3040-\u30FF]|[\uFF66-\uFF9D]|[\u4E00-\u9FAF]/;
  static const REGEX_ENG = /[a-vx-zA-VX-Z]|[ａ-ｖｘ-ｚＡ-ＶＸ-Ｚ]/;
  static const REGEX_URL = /https?:\/\/(www\.)?\S{2,256}\.[a-z]{2,6}\S*/g;
  static const REGEX_REACT = /<:[\S]+:\d+>/g;
  static const REGEX_USER = /<@!?\d+>/g;
  static const REGEX_CHAN = /<#\d+>/g;
  static const REGEX_ROLE = /<@&\d+>/g;
  static const REGEX_ID = /(<@!?|#|@&|:[\S]+:)\d+>/g;
  ...
  static const LANG = Object.freeze({
    ENG : 0,
    JPN : 1,
    OTH : 2,
    ESC : 3
  ...
  static lang(content, escapeStar=true) {
    ...
    if (jpCount == enCount) return LANG.OTH;
    if (jpCount < 3 && enCount < 3 && other > 0) return LANG.OTH; // it's probably a face
    return  jpCount * 1.7 > enCount ? LANG.JPN : LANG.ENG;
  }
}
