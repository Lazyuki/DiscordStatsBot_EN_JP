...
module.exports.alias = ['quickban', 'trollbegone'];
...
module.exports.command = async (message, content, bot, server) => {
  ...
  if (timestamp_id) {
    quickban.after = Discord.SnowflakeUtil.deconstruct(
      timestamp_id
    ).date.getTime();
  }
  ...
  message.channel.send(
    `✅ Quck ban settings applied. (Time ID: ${quickban.after}, Link: ${
      quickban.link
    }, RegEx: /${quickban.regex}/${ignoreCase ? 'i' : ''})`
  );
};
