...
module.exports.alias = ['unlockdown'];
...
module.exports.command = async (message, content, bot, server) => {
  ...
  JHO.permissionOverwrites
    ...
    .delete()
    .catch(() =>
      message.channel.send('Failed to delete Rai channel overwrites')
    ); // Rai

  message.channel.send(
    '✅  Phew... Lockdown has been lifted. Please go to https://mee6.xyz/dashboard/189571157446492161/welcome and re-enable welcome message in jho'
  );
};
