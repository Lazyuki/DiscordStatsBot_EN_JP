...
module.exports.command = (message, content, bot, server) => {
  let chan = message.channel;
	...
	if (message.member.hasPermission('MANAGE_ROLES')) {
		...
		msg += '\`auditlog (al)\` shows the last few interesting audit logs. \`,al [number <= 20 (default = 3)] [ALL_CAPS_ACTION] [Target User ID] [@mention the executor] \` Actions: <https://github.com/hydrabolt/discord.js/blob/stable/src/structures/GuildAuditLogs.js#L16>\n';
	}
