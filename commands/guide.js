...
module.exports.command = (message, content) => {
  ...
  if (content == '' || content == 'guide') {
    ...
    embed.title = 'The first step is learning Hiragana and Katakana.';
    ...
    embed.title = 'After you\'ve got your kana down, you need Kanji';
    ...
    embed.title = 'For vocabulary, three nice options are';
    embed.addField('Wanikani ($)', 'https://www.wanikani.com/', true);
    embed.addField('Memrise', 'https://www.memrise.com/', true);
    embed.addField('Anki', 'http://ankisrs.net/', true);
  } else if (content == 'ime') {
    embed.title = 'You need to have a software to type in Japanese';
    ...
    embed.title = 'For translating, avoid using Google Translate';
