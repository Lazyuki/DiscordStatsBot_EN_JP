...
module.exports.command = (message) => {
  ...
  embed.title = '__**WELCOME!! :tada: READ ME!**__[Resources for learning Japanese](https://github.com/ryry013/Awesome-Japanese/blob/master/readme.md)';
  ...
  embed.addField('weee', 'welp', false);
