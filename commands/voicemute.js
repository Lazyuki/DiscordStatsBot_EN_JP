...
module.exports.command = async (message, content) => {
  ...
  for (let [ , member] of targets) {
    ...
    await member.send(`You have been voice muted in the English-Japanese Language Exchange server for: ${reason}. Contact one of the mods if you need to discuss it.`);
